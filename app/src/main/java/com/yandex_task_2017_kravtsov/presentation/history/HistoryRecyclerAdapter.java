...
final class HistoryRecyclerAdapter extends RecyclerView.Adapter<HistoryRecyclerAdapter.ViewHolder> {
    ...
    void updateHistory(List<Translation> translations) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.historyListItem_directionTextView)
        TextView directionTextView;
        @BindView(R.id.historyListItem_fromTextView)
        TextView fromTextView;
        @BindView(R.id.historyListItem_toTextView)
        TextView toTextView;
